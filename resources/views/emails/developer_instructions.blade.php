...
<p>
    Hi! {{ $user->name }} is about to try out <a href="{{ url('/') }}">A/B Testing Lab</a>, but before that you must install our script on your webpage <a href="{{ $website->url }}">{{ $website->title }}</a>.
